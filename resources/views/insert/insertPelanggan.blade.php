...
@section('content')
    <div class="form-group mb-3">
        <h1 class="h3 text-black-1000">Tambah Data Pelanggan</h1>
    </div>
    ...
    <form action="/insertpelanggan" method="POST">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" name="lokasi_awal" class="form-control" id="lokasi_awal" required>
        </div>
